...
```bash
node ~/.dynamic-builder/.agent/common/scripts/build-agents.js
node ~/.dynamic-builder/.agent/common/scripts/build-agents.js --watch
node ~/.dynamic-builder/.agent/common/scripts/build-agents.js --clean
```
